...
export default defineConfig({
  ...
  //tempo máximo para cada teste completo (30.000 é o padrão)
  timeout: 60_000,

  //tempo máximo para assertivos (toBeVisible(), toHaveText() => (deixar 5 segundos, não mudar))

  expect: {
    timeout: 5000, //não vale a pena aumentar porque o teste pode ficar mais lento na execução, vale a pena usar o timeout explicito
  },
